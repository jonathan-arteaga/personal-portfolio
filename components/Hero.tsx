...
export const Hero: React.FC = () => {
  ...
  const fullText = "I build systems.";
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 py-24 md:py-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center min-h-[70vh]">
          ...
          <div className="flex flex-col justify-center order-2 lg:order-1">
            ...
            >
              Lead SE at Salesforce. AI early adopter. 18 years in sales.
            </p>
            ...
            {/* Tagline */}
            <p
              className={`font-mono text-fluid-sm md:text-fluid-base text-muted max-w-lg mb-10 transition-opacity duration-500 tracking-wide ${
                typingComplete ? 'opacity-100' : 'opacity-0'
              }`}
            >
              I make the complex simple. I build what sales needs to close.
            </p>
